...
final class LocalNetworkPermissionMonitor: @unchecked Sendable {
    static let shared = LocalNetworkPermissionMonitor()

    private let queue = DispatchQueue(label: "elevenlabs.localnetwork.monitor")
